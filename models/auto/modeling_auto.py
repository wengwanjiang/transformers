...
MODEL_FOR_CAUSAL_LM_EAGLE3_MAPPING_NAMES = OrderedDict(
                                                [
                                                    # Base model mapping
                                                    ("llama", "LlamaForCausalLMEagle3")
                                                ]
                                            )
MODEL_FOR_CAUSAL_LM_EAGLE3_MAPPING = _LazyAutoMapping(CONFIG_MAPPING_NAMES, MODEL_FOR_CAUSAL_LM_EAGLE3_MAPPING_NAMES)
...
class AutoEagle3DraftModel(_BaseAutoModelClass):
    ...
    # }
    _model_mapping = MODEL_FOR_CAUSAL_LM_EAGLE3_MAPPING
    @classmethod
...
AutoEagle3DraftModel= auto_class_update(AutoEagle3DraftModel, head_doc="eagle3 draft modeling")
