...
class Trainer:
    ...
    def __init__(
        ...
        if self.is_model_parallel: # or True:
            self.args._n_gpu = 1
    ...
    def evaluate(
        ...
        # print(self.args.use_legacy_prediction_loop) # False
    ...
    def evaluation_loop(
        ...
        for step, inputs in enumerate(dataloader):
            ...
            # print(inputs) # verified by wwj , inputs_ids, attention_mask, loss_mask, hidden_state: None, target: None
            
            # Prediction step
            losses, logits, labels = self.prediction_step(model, inputs, prediction_loss_only, ignore_keys=ignore_keys)
            # if step > 5:
            #     break # aiyushan
            # print(losses, logits, labels)
            main_input_name = getattr(self.model, "main_input_name", "input_ids")
            inputs_decode = (
